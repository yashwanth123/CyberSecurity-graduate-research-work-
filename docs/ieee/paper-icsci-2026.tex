...
\author{
\IEEEauthorblockN{[Your First Name] [Your Last Name]}
...
\begin{enumerate}
    ...
    \item Empirical baseline results from a manufacturing case study: 49.1\% maturity, SL gaps, and four critical risks.
...
\section{Methodology}
We adopt Design Science Research (DSR)~\cite{hevner2004design}: (1)~problem identification, (2)~artifact design, (3)~demonstration, (4)~evaluation, (5)~communication. Evaluation combines descriptive metrics from a single embedded case study at an anonymized automotive tier-1 supplier (Assembly Line~2).

\textbf{System Under Consideration (SuC).} The SuC includes four Siemens S7-1500 PLCs, HMIs, engineering workstations, PI historian connectivity, MES integration, and vendor remote access via a DMZ jump host---representative brownfield manufacturing OT.
...
\caption{Compliance maturity by IEC 62443 part (case study, $n=107$ questions). Dashed line: overall 49.1\%.}
\label{fig:maturity}
\end{figure}
...
% \begin{tabular}{lrr}
% \toprule
% Part & Maturity (\%) & Questions \\
% \midrule
% General & 66.7 & 3 \\
% Policies and Procedures & 55.0 & 20 \\
% System & 43.6 & 55 \\
% Component & 53.4 & 29 \\
% \midrule
...
\textbf{Limitations.} Single-site case study; manual SL-A assessment; 107-question subset of full standard; simulated pilot data for demonstration (replace with primary site data when available).
...
We presented an open IEC~62443 assessment framework validated through a manufacturing IACS case study. Future work includes multi-site validation, dual-assessor reliability study, automated SL-A verification from configuration exports, and integration with passive OT asset discovery.
...
The author thanks the IEC~62443 and ISA99 community for public guidance materials used in this research.
